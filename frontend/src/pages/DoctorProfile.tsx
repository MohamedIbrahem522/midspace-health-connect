    ...
    try {
      ...
      if (data.id) {
        setForm({
          ...
          experience: String(data.yearsOfExperience || 0),
          workplace: data.hospital || "",
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <div className="flex-1 pt-10 sm:pt-0">
              ...
              <div className="flex flex-wrap gap-3 mt-2 text-xs text-muted-foreground">
                <span className="flex items-center gap-1"><MapPin className="h-3 w-3" /> {form.location || "Not set"}</span>
                <span className="flex items-center gap-1"><Building2 className="h-3 w-3" /> {form.workplace || "Not set"}</span>
        ...
        <div className="px-6 py-4 border-t flex items-center justify-between">
          ...
          {step < steps.length - 1 ? (
            ...
            <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
              <Button onClick={handleSave} disabled={saving} className="h-9 text-sm gap-1 bg-primary hover:bg-primary/90">
